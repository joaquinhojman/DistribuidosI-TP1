...
def generateServices(docker_compose, config_params):
    ...
    generateEOFTripsListener(docker_compose,config_params["TBRKCANT"], config_params["TE2FCANT"], config_params["TE3FCANT"], config_params["EJ1TCANT"], config_params["EJ2TCANT"], config_params["EJ3TCANT"])
