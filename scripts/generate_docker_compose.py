...
def initialize_config():
    ...
    try:
        ...
        config_params["SE2FCANT"] = int(os.getenv('SE2FCANT', config["DEFAULT"]["SE2FCANT"]))
...
def generateEjTSolvers(docker_compose, ej1tcant, ej2tcant, ej3tcant, we1fcant, se2fcant, se3fcant):
...
def generateEOFTListener(docker_compose, tbrkcant, te2fcant, te3fcant, ej1tcant, ej2tcant, ej3tcant, rmqretries):
    ...
    docker_compose.write(f'      restart: on-failure\n')
    docker_compose.write(f'      depends_on:\n')
    docker_compose.write(f'        - Ej1tSolver_1\n')
    docker_compose.write(f'      links: \n')
    docker_compose.write(f'        - rabbitmq\n')
    docker_compose.write(f'      environment:\n')
    docker_compose.write(f'        - TE2FCANT={te2fcant}\n')
...
def generateServices(docker_compose, config_params):
    ...
    generateEj1Solver(docker_compose, config_params["EJ1TCANT"])
    generateEj2Solver(docker_compose, config_params["EJ2TCANT"])
    generateEj3Solver(docker_compose, config_params["EJ3TCANT"])
    generateEjTSolvers(docker_compose, config_params["EJ1TCANT"], config_params["EJ2TCANT"], config_params["EJ3TCANT"], config_params["WE1FCANT"], config_params["SE2FCANT"], config_params["SE3FCANT"])
    ...
    generateEOFTListener(docker_compose,config_params["TBRKCANT"], config_params["TE2FCANT"], config_params["TE3FCANT"], config_params["EJ1TCANT"], config_params["EJ2TCANT"], config_params["EJ3TCANT"])
